    ...
    return (
        <section className={`${styles.startPartnerReferringSec}`}>
            <div className={`${styles.maContainer}`}>
                <h2 className={`${styles.secTitle}`}>Start Partner Referring Sec</h2>
        
                <div className={`${styles.formHolderc}`}>
                    <div className={`${styles.referrbarInpupat}`} id="inputsContainer">
                        ...
                        <p id="redmsg-err1" className={`${styles.redmsgErr2}`}>Oops, this number is already registered with us, try adding another number</p>
