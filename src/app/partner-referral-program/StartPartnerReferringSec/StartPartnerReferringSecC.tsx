...
function StartPartnerReferringSecC() {
    ...
    const handleFormSubmit = () => {
        ...
        if (
            Object.entries(partner).some(([key, value]) => value == '')) {

            setPerr(prev => ({ ...prev, name: !partner.name ? 'name is required' : '', number: !partner.number ? 'number is required' : '' }))
        }
        if (reference.map((ref, i) => {
