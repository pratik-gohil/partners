...
function RevenueSharing({dictionary}: any) {
    return (
        <section className={styles["revenueSharingSec"]}>
            <div className={styles["maContainer"]}>
                <h2 className={`${styles["secTitle"]} `}> {dictionary["secTitle"]}<span>{dictionary["secTitle1"]}</span></h2>
                <div className={styles["un100BrokerageWrap"]}>
                    <div className={styles["un100BrokBox"]}>
                        ...
                        <h3 className={styles["brokerageTitle"]}> {dictionary["brokerageTitle"]}</h3>
                        <p className={styles["caption"]}><b>{dictionary["caption"]}</b> {dictionary["caption1"]}</p>
                    </div>
                    <div className={styles["midRsDivider"]}>
                        <span className={styles["dot1"]}></span>
                        <Image width={500} height={500} alt="Revenue Sharing" src="/revenueSharing-midd.webp" />
                        <span className={styles["dot2"]}></span>
                    </div>
                    <div className={styles["un100BrokKeyPoints"]}>
                        <h3 className={styles["keyPointsTitle"]}>{dictionary["keyPointsTitle"]}</h3>
                        <ul>
                            <li><span className={styles["keyPoint"]}><span></span></span> {dictionary["keyPoint1"]}</li>
                            <li><span className={styles["keyPoint"]}><span></span></span> {dictionary["keyPoint2"]}</li>
                            <li><span className={styles["keyPoint"]}><span></span></span> {dictionary["keyPoint3"]}</li>
                            <li><span className={styles["keyPoint"]}><span></span></span> {dictionary["keyPoint4"]}</li>
                            <li><span className={styles["keyPoint"]}><span></span></span> {dictionary["keyPoint5"]}</li>
                            <li><span className={styles["keyPoint"]}><span></span></span> {dictionary["keyPoint6"]}</li>
                        </ul>
                    </div>
                </div>
                <div className={styles["un2024MidText"]}>{dictionary["un2024MidText"]}</div>
                <div className={styles["mtfPledge24"]}>
                    <ul>
                        <li>
                            <h4 className={styles["marginTitle"]}>MTF {dictionary["marginTitle1"]}</h4>
                            <p><b>{dictionary["marginTitle2"]}</b> {dictionary["marginTitle3"]} <b>{dictionary["marginTitle4"]}</b></p>
                        </li>
                        <li>
                            <h4 className={styles["marginTitle"]}>{dictionary["marginTitle5"]}</h4>
                            <p><b>{dictionary["marginTitle6"]}</b> {dictionary["marginTitle7"]} <b>{dictionary["marginTitle8"]}</b> </p>
                        </li>
                    </ul>
