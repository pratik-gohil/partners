            ...
            <div className={`${styles.maContainer} ${styles.flex}`}>
                <div className={`${styles.lhsWrap}`}>
                    <h2 className={`${styles.bannerTitle}`}>
                        ...
                        <span>business</span>
                        <b className={`${styles.b2}`}>opport<Image priority src="/referrals/text-U-img.webp" alt='opportunity…' width={45} height={45} quality={100} />&nbsp;nity…</b>
                    </h2>
                    <div className={`${styles.priceBandStrip}`}>₹6,000 per successful registration!</div>
                </div>
                <div className={`${styles.rhsWrap}`}>
                    <Image priority src="/referrals/banner-img.webp" alt='Refer a partner & share this UNBEATABLE business OPPORTUNITY…' width={500} height={500} quality={100} />
                </div>
            </div>
        </section>
    )
