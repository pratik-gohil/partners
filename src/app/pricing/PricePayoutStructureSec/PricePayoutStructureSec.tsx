      ...
      <div className={`${styles.maContainer}`}>
          ...
          <div className={`${styles.pricingTableHolder}`}>
            <table width="100%"><tbody>
              ...
              <tr>
                ...
                <td>
                  <b className={`${styles.orangeTxt}`}>100%</b> above ₹500
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <b className={`${styles.orangeTxt}`}>100%</b> across all
                  segments
                </td>
                <td>
                  Select from our standard plans or create a customised plan for
                  your clients
                </td>
              </tr>
              <tr>
                <td>
                  <b>MTF (eMargin) interest</b>
                </td>
                <td>
                  <b className={`${styles.orangeTxt}`}>80%</b> interest sharing
                  beyond 9.99%
                </td>
              ...
              <tr>
                <td>
                  <b>Account Maintenance Charges (DP AMC)</b>
                </td>
                <td>
                  <b className={`${styles.orangeTxt}`}>100%</b> revenue beyond
                  ₹480
                </td>
                <td rowSpan={3}>
                  Select from our standard DP plans or create a customised DP
                  plan for your clients
                </td>
              </tr>
              <tr>
                <td>
                  <b>Pledge/Unpledge charges</b>
                </td>
                <td>
                  Customise and earn
                  <b className={`${styles.orangeTxt}`}>100%</b>
                </td>
              </tr>
              <tr>
                <td>
                  <b>DP sell transaction charges</b>
                </td>
                <td>
                  Customise and earn
                  <b className={`${styles.orangeTxt}`}>100%</b>
              ...
              <tr>
                <td>
                  <b>Delayed Payment Charges (DPC)</b>
                </td>
                <td>
                  <b className={`${styles.orangeTxt}`}>Flat 20%</b> sharing
                </td>
                <td>No customisation possible</td>
              </tr>
              <tr>
                <td>
                  <b>Operating charges</b>
                </td>
                <td>
                  <b className={`${styles.orangeTxt}`}>Flat 20%</b> sharing
                </td>
        ...
        <div className={`${styles.tableStructureWrap}`}>
          ...
          <div className={`${styles.tableTitleWrap} ${styles.flex}`}>
            ...
            <h3 className={`${styles.tableTitle}`}>
              Income from Account Opening Fee
            </h3>
          </div>
          <p>
            Select from a range of account opening fee for your client and get
            ...
            <table width="100%"><tbody>
              ...
              <tr>
                ...
                <th>
                  ...
                  <small>Partner service fee* (annual recurring)</small>
                </th>
              </tr>
              <tr>
            ...
            <table width="100%"><tbody>
              ...
              <tr>
                ...
                <td className={`${styles.textLeft}`}>
                  ₹0 brokerage for life across all segments
                </td>
              ...
              <tr>
                ...
                <td className={`${styles.textLeft}`}>
                  ₹0 brokerage only on delivery <br /> ₹20 brokerage per order
              ...
              <tr>
                ...
                <td className={`${styles.textLeft}`}>
                  ...
                  <ul>
                    ...
                    <li>
                      <b className={`${styles.fontSemiBold}`}>Traditional</b>
                      <small>(variable)</small>
                    </li>
                    <li>
                      <b className={`${styles.fontSemiBold}`}>Hybrid</b>
                    </li>
                  </ul>
                </td>
                <td className={`${styles.textCenter}`}>
        ...
        <div className={`${styles.tableStructureWrap}`}>
          ...
          <div className={`${styles.tableTitleWrap} ${styles.flex}`}>
            ...
            />
            <h3 className={`${styles.tableTitle}`}>
              Income from MTF (eMargin) Interests
            </h3>
          </div>
          <p>
            You can either select our standard interest rates, i.e. base
            interest rates or choose to customise the interest rates applicable
            to the client.
          </p>
          <div className={`${styles.pricingTableHolder}`}>
          ...
          <p>
            <b className={`${styles.orangeTxt}`}>Note:</b> You can earn 5% by
            charging our standard MTF interest rates to your clients. However,
            if you want to charge your clients below 9.99% and up to 6.99% p.a
        ...
        <div className={`${styles.tableStructureWrap}`}>
          ...
          <div className={`${styles.tableTitleWrap} ${styles.flex}`}>
            ...
            />
            <h3 className={`${styles.tableTitle}`}>
              Income from Margin Pledge Interests
            </h3>
          </div>
          <p>
            You can either select our standard interest rates, i.e. base
        ...
        <div className={`${styles.tableStructureWrap}`}>
          ...
          <div className={`${styles.tableTitleWrap} ${styles.flex}`}>
            ...
            />
            <h3 className={`${styles.tableTitle}`}>
              Income from Account Maintenance Charges (DP AMC)
            </h3>
          </div>
          <p>
            You can either select from our standard DP AMC plans or customise
              ...
              <thead>
                ...
                <tr>
                  ...
                  <th colSpan={3} className={`${styles.blueBgBox}`}>
                    <span>Customised AMC Plans</span>
                  </th>
                </tr>
              </thead>
                <tbody>
        ...
        <div className={`${styles.tableStructureWrap}`}>
          ...
          <div className={`${styles.tableTitleWrap} ${styles.flex}`}>
            ...
            />
            <h3 className={`${styles.tableTitle}`}>
              Income from Pledge and Unpledge charges
            </h3>
          </div>
          <p>
            You can either select from our standard pledge/unpledge rates of ₹25
            or ₹32 or customise client's pledge/unpledge charges from a range of
            rates, i.e., ₹25 to ₹35
          </p>
          <div className={`${styles.pricingTableHolder}`}>
        ...
        <div className={`${styles.tableStructureWrap}`}>
          ...
          <div className={`${styles.tableTitleWrap} ${styles.flex}`}>
            ...
            />
            <h3 className={`${styles.tableTitle}`}>
              Income from DP Sell transaction charges
            </h3>
          </div>
          <p>
            You can either select from our standard DP sell transaction charge
            of ₹12 per ISIN or customise client’s DP Sell transaction charges
        ...
        <div className={`${styles.tableStructureWrap}`}>
          ...
          <div className={`${styles.tableTitleWrap} ${styles.flex}`}>
            ...
            />
            <h3 className={`${styles.tableTitle}`}>
              Income from Delayed Payment Charges & Operating Charges
            </h3>
          </div>
          <p>
            Earn flat 20% income sharing from DPC interest earned on client’s
          ...
          <div className={`${styles.pricingTableHolder}`}>
            ...
            <table width="100%"><tbody>
              ...
              <tr>
                ...
                <td>
                  <b className={`${styles.orangeTxt}`}>Flat 20%</b>
                </td>
              </tr>
            </tbody></table>
          </div>
